...
/**
 * Classe di utilità per la gestione centralizzata delle eccezioni e la
 * visualizzazione di messaggi di errore all’utente tramite finestre di dialogo
 * JavaFX.
 *
 * <p>La classe fornisce un metodo statico {@link #errore(String, Exception, boolean, Consumer)}
 ...
 * </p>
 *
 * <p>Se richiesto, la finestra può includere un pulsante aggiuntivo per permettere
 * all’utente di selezionare un file alternativo, eseguendo poi un’azione definita
 * dal chiamante tramite una {@link Consumer}.</p>
 *
...
public class GestioneEccezioni {
    /**
     * Mostra un messaggio di errore all’utente tramite una finestra di dialogo JavaFX.
     *
     * @param header  il testo da mostrare come intestazione del messaggio di errore.
     * @param e       l’eccezione associata (opzionale). Se non è {@code null},
     *                lo stack trace verrà mostrato in un riquadro espandibile.
     * @param bottone se {@code true}, viene aggiunto un pulsante "Scegli un altro file"
     *                che consente all’utente di selezionare un file alternativo.
     * @param azione  l’azione da eseguire sul file scelto, nel caso in cui
     *                l’utente selezioni un file alternativo. Ignorata se {@code bottone}
     *                è {@code false}.
     *
     * @implNote L’uso di questo metodo blocca il thread corrente fino alla chiusura
     *           della finestra di dialogo, poiché si basa su {@link Alert#showAndWait()}.
     */
