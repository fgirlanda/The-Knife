...
/**
 * Enumerazione che rappresenta diverse soglie di distanza utilizzabili come
 * filtro.
 *
 * <p>
 ...
 * <li>{@link #OLTRE} → oltre 30 km (internamente rappresentato con
 * {@link Double#MAX_VALUE}).</li>
 * </ul>
 *
 * <p>
 * Ogni valore dell'enum ha associato un valore numerico in chilometri
 * accessibile tramite {@link #getKM()}.
 * </p>
 *
 * <p>
...
public enum Distanza {
     ...
     *         ({@code "10 km"}, {@code "20 km"}, {@code "30 km"} o
     *         {@code "50+ km"}).
     */
    @Override
